                ...
                <form action="{{route('register.store')}}" method="post">
                  ...
                  <input type="hidden" name="course_id" value="{{$course->id}}">
                    ...
                    <div class="tab"> Personal INFO
                        ...
                        value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}"   data-rule="minlen:4" name="birthday" required /></p>
                        <p>
                    ...
                    <div class="tab">Addition INFO
                        ...
                        value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}"   name="whenWasthat" placeholder="When was that" data-msg="Please enter a valid email" required />
                        </p>
                    ...
                    <div class="tab">Regestration feeses
